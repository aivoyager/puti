...
{states}
Just answer a number between 0-{n_states} OR number -1（means you have completed your goal and don't need to go to any of the stages）,
 choose the most suitable stage according to the understanding of the conversation.
Please note that the answer only needs a number, no need to add any other text.
If you think you have completed your goal and don't need to go to any of the stages, return '-1', that's important!
